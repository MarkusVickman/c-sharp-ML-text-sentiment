...
namespace MyMLApp
{
    public partial class SentimentModelSwedishTranslated
    {
        public const string RetrainFilePath =  @"C:\Users\marku\Desktop\webbutveckling-ht2024\c#\moment4\myMLApp\myMLApp\yelp_swedish_translated_labelled.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(new LbfgsMaximumEntropyMulticlassTrainer.Options(){L1Regularization=0.058571924F,L2Regularization=0.13857865F,LabelColumnName=@"col1",FeatureColumnName=@"Features"}))      
